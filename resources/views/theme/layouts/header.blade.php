...
<head>
    <meta charset="utf-8">
    <title>Demo Ecommerce Project</title>
    ...
    <link rel="stylesheet" href="{{ asset('theme/assets/css/plugins/glightbox.min.css') }}">
                ...
                <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                    <div class="header__shipping">
                        <ul class="header__shipping--wrapper d-flex">
                            <li class="header__shipping--text text-white">Welcome to Demo Project</li>
            ...
            <div class="container-fluid">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="{{route ('index') }}"><img class="main__logo--img" src="{{ asset('uploads/logo/' . (siteLogo()->logo ?? 'default-logo.png')) }}"
                                    alt="logo-img"></a></h1>
                    </div>
                        ...
                        <ul class="d-flex">
                            ...
                            <li class="header__account--items d-none d-lg-block">
                                <a class="header__account--btn" href="wishlist">
                                    ...
                                    <span class="items__count wishlist_item" data-cart-url="{{ route('wishlist.count') }}">0</span>
                                </a>
                            </li>
                            <li class="header__account--items">
                                <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                                    ...
                                    <span class="items__count cart_item" data-cart-url="{{ route('cart.count') }}">0</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <li class="header__menu--items mega__menu--items style2">
                                    ...
                                    <ul class="header__mega--menu d-flex">
                                        ...
                                        <li class="header__mega--menu__li">
                                            ...
                                            <span class="header__mega--subtitle">{{ $cat->name }}</span>
                        ...
                        <ul class="d-flex">
                            ...
                            <li class="header__account--items header__account2--items d-none d-lg-block">
                                <a class="header__account--btn" href="wishlist">
                                    ...
                                    <span class="items__count  wishlist style2 wishlist_item" data-cart-url="{{ route('wishlist.count') }}">0</span>
                                </a>
                            </li>
                            <li class="header__account--items header__account2--items">
                                <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                                    ...
                                    <span class="items__count style2 cart_item" data-cart-url="{{ route('cart.count') }}">0</span>
                                </a>
                            </li>
                        </ul>
                    </div>
    ...
    : asset('theme/assets/img/default-logo.png') }}"
                    ...
                    <ul class="offcanvas__menu_ul">
                        ...
                        <li class="offcanvas__menu_li">
                            ...
                            <ul class="offcanvas__sub_menu">
                                ...
                                {{-- 4 Columns Auto Chunk --}}
                                @foreach($categories->chunk( ceil($categories->count() / 4) ) as $column)
                                <li class="offcanvas__sub_menu_li">

                                    {{-- Column Heading = First category name --}}
                                    <a href="#" class="offcanvas__sub_menu_item">
                                        {{ $column->first()->name ?? 'Category' }}
                                    </a>
                                    ...
                                    <ul class="offcanvas__sub_menu">
                                        ...
                                        <!-- <li class="offcanvas__sub_menu_li">
                                            <a class="offcanvas__sub_menu_item" href="{{ url('category/'.$cat->id) }}">
                                                {{ $cat->name }}
                                            </a>
                                        </li> -->
        ...
        <div class="offCanvas__minicart">
            ...
            <div class="minicart__button d-flex justify-content-center">
                <a class="primary__btn minicart__button--link" href="cart-page">View cart</a>
