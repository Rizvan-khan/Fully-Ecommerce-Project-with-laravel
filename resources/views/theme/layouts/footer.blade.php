 <!-- Start footer section -->
    ...
    <!-- Quickview Wrapper -->
    <div class="modal modal-data" id="modal1" data-animation="slideInUp">
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  ...
  <script src="{{ asset('theme/assets/js/vendor/popper.js')}}" defer="defer"></script>
  <script src="{{ asset('theme/assets/js/vendor/bootstrap.min.js')}}" defer="defer"></script>
  <script src="{{ asset('theme/assets/js/plugins/swiper-bundle.min.js')}}"></script>
  <script src="{{ asset('theme/assets/js/plugins/glightbox.min.js')}}"></script>
<script>
    const CART_ROUTE = "{{ route('add.to.cart') }}";
