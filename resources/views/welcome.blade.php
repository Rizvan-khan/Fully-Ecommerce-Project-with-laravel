    ...
    <section class="product__section section--padding pt-20">
        <div class="container-fluid">
            <div class="section__heading text-center mb-35">
                <h2 class="section__heading--maintitle">Our Latest Products</h2>
            </div>
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        ...
                                        <a class="product__items--link" href="{{route('product-detail',$product->id)}}">
                                    ...
                                    <div class="product__items--content">
                                        ...
                                        <ul class="rating product__rating d-flex">
                                            @for ($i = 1; $i <= 5; $i++)
                                                ...
                                                <span class="rating__list--icon {{ $i <= $product->rating ? 'active' : '' }}">
                                                    ⭐
                                                </span>
                                                </li>
                                                @endfor
                                        ...
                                        <ul class="product__items--action d-flex">
                                            <li class="product__items--action__list">
                                                ...
                                                <a class="product__items--action__btn add__to--cart addtocart-btn addToCartBtn"
                                            ...
                                            <li class="product__items--action__list">
                                                <a class="product__items--action__btn addToWish"
                                                    data-id="{{ $product->id }}" data-price="{{ $product->price }}">
