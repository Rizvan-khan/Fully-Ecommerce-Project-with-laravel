            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3 text-center">
                        <h5 class="mt-1">✏️ Edit Category</h5>
                    </div>
                    ...
                    <form action="{{ route('admin.category.update', $cat->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if($cat->image)
                            <div class="mb-3">
                                <p>Current Image:</p>
                                <img src="{{ asset('uploads/categories/' . $cat->image) }}" alt="Category Image" width="100" class="rounded">
                            </div>
                        @endif
                        ...
                        <div class="text-center">
                            ...
                            <a href="{{ route('admin.manage-category') }}" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
