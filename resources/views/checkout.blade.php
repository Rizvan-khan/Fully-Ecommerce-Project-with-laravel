        ...
        <div class="checkout__page--inner d-flex">
            <div class="main checkout__mian">
                                ...
                                <table class="checkout__total--table">
                                    <tbody class="checkout__total--body">
                                        <tr class="checkout__total--items">
                                            ...
                                            <td class="checkout__total--amount text-right cartTotalAmount">$0.00</td>
                                        </tr>
                                        <tr class="checkout__total--items">
                ...
                <main class="main__content_wrapper">
                    <form id="checkoutForm" data-action="{{ route('save-details') }}">
                        @csrf
                        <div class="checkout__content--step section__contact--information">
                            ...
                            <div class="customer__information">
                                <div class="checkout__email--phone mb-12">
                                    <label>
                                        <input class="checkout__input--field border-radius-5" readonly value="{{ $user->email }}" placeholder="Email or mobile phone mumber" type="text">
                                    </label>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-12">
                                        <div class="checkout__input--list ">
                                            <label>
                                                <input name="name" class="checkout__input--field border-radius-5" value="{{ $user->name }}" placeholder="Full name" type="text">
                                    ...
                                    <div class="col-12 mb-12">
                                        <div class="checkout__input--list">
                                            <label>
                                                <input name="address" value="{{ $user->detail->address ?? '' }}"
                                                    class="checkout__input--field border-radius-5" placeholder="Address1" type="text">
                                    ...
                                    <div class="col-12 mb-12">
                                        <div class="checkout__input--list">
                                            <label>
                                                <input value="{{ $user->detail->district ?? '' }}" name="district" class="checkout__input--field border-radius-5" placeholder="City" type="text">
                                                <small class="text-danger error-text district_error"></small>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 mb-12">
                                        <div class="checkout__input--list">
                                            <label>
                                                <input value="{{ $user->detail->state ?? '' }}" name="state" class="checkout__input--field border-radius-5" placeholder="State" type="text">
                                    ...
                                    <div class="col-lg-6 mb-12">
                                        <div class="checkout__input--list">
                                            <label>
                                                <input value="{{ $user->detail->pin_code ?? '' }}" name="pin_code" class="checkout__input--field border-radius-5" placeholder="Postal code" type="text">
                                                <small class="text-danger error-text pin_code_error"></small>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="checkout__content--step__footer d-flex align-items-center">
                            ...
                            <a class="previous__link--content" href="cart-page">Return to cart</a>
                        </div>
                    </form>
                </main>
                <footer class="main__footer checkout__footer">
                    <p class="copyright__content">Copyright © 2025 <a class="copyright__content--link text__primary" href="index">Demo Project</a> . All Rights Reserved.Design By Rizvan Khan</p>
                </footer>
            </div>
                ...
                <div class="checkout__total">
                    <table class="checkout__total--table">
                        ...
                        <tfoot class="checkout__total--footer">
                            <tr class="checkout__total--footer__items">
                                <td class="checkout__total--footer__title checkout__total--footer__list text-left">Total </td>
                                <td class="checkout__total--footer__amount checkout__total--footer__list text-right cartTotalAmount">$0.00</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
