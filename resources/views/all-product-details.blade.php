     ...
     <div class="offcanvas__filter--sidebar__inner">
             ...
             <ul class="widget__categories--menu">
                 ...
                 <li class="widget__categories--menu__list">
                     <label class="widget__categories--menu__label d-flex align-items-center">
                         <img class="widget__categories--menu__img" src="{{asset('uploads/categories/'.$cate->image )}}" alt="categories-img">
                     ...
                     <ul class="widget__categories--sub__menu">
                         ...
                         <li class="widget__categories--sub__menu--list">
                             <a class="widget__categories--sub__menu--link d-flex align-items-center" href="{{route('all-product-details',$sub->id)}}">
                                 <img class="widget__categories--sub__menu--img" src="{{ asset($sub->image) }}" alt="categories-img">
                 ...
                 <div class="price__filter--form__inner mb-15 d-flex align-items-center">
                     <div class="price__filter--group">
                         ...
                         <div class="price__filter--input border-radius-5 d-flex align-items-center">
                             ...
                             <label>
                                 <input class="price__filter--input__field border-0" name="min_price" id="Filter-Price-GTE2" type="number" placeholder="0" value="{{ request('min_price') }}" min="200" >
                             </label>
                         </div>
                     </div>
                     ...
                     <div class="price__filter--group">
                         ...
                         <div class="price__filter--input border-radius-5 d-flex align-items-center">
                             <span class="price__filter--currency">$</span>
                             <label>
                                 <input  value="{{ request('max_price') }}" class="price__filter--input__field border-0" name="max_price" id="Filter-Price-LTE2" type="number" placeholder="250.00" >
                             </label>
                         </div>
                     </div>
                 </div>
         ...
         <div class="single__widget widget__bg">
             ...
             <ul class="widget__tagcloud">
                 <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop">Jacket</a></li>
                </ul>
         </div>
     </div>
 </div>
                 ...
                 <div class="col">
                     <div class="breadcrumb__content text-center">
                         ...
                         <ul class="breadcrumb__content--menu d-flex justify-content-center">
                             <li class="breadcrumb__content--menu__items"><a class="text-white" href="index">Home</a></li>
     ...
     <section class="shop__section section--padding">
         <div class="container">
             <div class="shop__header bg__gray--color d-flex align-items-center justify-content-between mb-30">
                 ...
                 <p class="product__showing--count">Showing 1–20 results</p>
             </div>
             <div class="row">
                 <div class="col-12">
                                         ...
                                         <div class="col mb-30">
                                             ...
                                             <div class="product__items ">
                                                 <div class="product__items--thumbnail">
                                                     <a class="product__items--link" href="{{route('product-detail',$item->id)}}">
                                                         <img class="product__items--img product__primary--img" src="{{ asset($item->image) }}" alt="{{ $item->name }}">
                                                         <img class="product__items--img product__secondary--img" src="{{ asset($item->image) }}" alt="{{ $item->name }}">
                                                     </a>
                                                 ...
                                                 <div class="product__items--content">
                                                     ...
                                                     <h3 class="product__items--content__title h4"><a href="{{route('product-detail',$item->id)}}">{{ $item->name }}</a></h3>
                                                     <div class="product__items--price">
                                             ...
                                             <div class="product__items product__list--items d-flex">
                                                 <div class="product__items--thumbnail product__list--items__thumbnail">
                                                     <a class="product__items--link" href="product-details">
                                                         <img class="product__items--img product__primary--img" src="{{ asset($item->image) }}" alt="product-img">
                                                         <img class="product__items--img product__secondary--img" src="{{ asset($item->image) }}" alt="product-img">
                                                     </a>
                                                     <div class="product__badge">
                                                         <span class="product__badge--items sale">Sale</span>
                                                     </div>
                                                 ...
                                                 <div class="product__list--items__content">
                                                     ...
                                                     <h3 class="product__list--items__content--title h4 mb-10"><a href="product-details">{{ $item->name }}</a></h3>
                                                     ...
                                                     <p class="product__list--items__content--desc mb-15">{{$item->description}}</p>
                                                     <ul class="product__items--action d-flex">
                                                         <li class="product__items--action__list">
