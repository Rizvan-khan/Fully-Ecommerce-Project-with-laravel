                ...
                <div class="row row-cols-lg-2 row-cols-md-2">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset($product_details->image) }}"><img class="product__media--preview__items--img" src="{{ asset($product_details->image) }}" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{ asset($product_details->image) }}" data-gallery="product-media-preview">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{ asset($product_details->image) }}" alt="product-nav-img">
                                        </div>
                                    </div>
                    ...
                    <div class="col">
                        <div class="product__details--info">
                            <form action="#">
                                <h2 class="product__details--info__title mb-15">{{ $product_details->name }}</h2>
                                <div class="product__details--info__price mb-10">
                                    <span class="current__price">{{ $product_details->price }}</span>
                                    <!-- <span class="price__divided"></span> -->
                                    <!-- <span class="old__price">{{ $product_details->discount_price }}</span> -->
                                </div>
                                ...
                                <p class="product__details--info__desc mb-15">{{ $product_details->description }}</p>
                                <div class="product__variant">
                                    ...
                                    <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                        ...
                                        <a class="quickview__cart--btn primary__btn addToCartBtn" data-id="{{ $product_details->id }}" data-price="{{ $product_details->price }}">Add To Cart</a>  
                                    </div>
                                    <div class="product__variant--list mb-15">
                                        <a class="variant__wishlist--icon mb-15 addToWish" data-id="{{ $product_details->id }}" data-price="{{ $product_details->price }}" title="Add to wishlist">
                                            <svg class="quickview__variant--wishlist__svg" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 512 512"><path d="M352.92 80C288 80 256 144 256 144s-32-64-96.92-64c-52.76 0-94.54 44.14-95.08 96.81-1.1 109.33 86.73 187.08 183 252.42a16 16 0 0018 0c96.26-65.34 184.09-143.09 183-252.42-.54-52.67-42.32-96.81-95.08-96.81z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/></svg>
                                            Add to Wishlist
                                        </a>
                                        <button class="variant__buy--now__btn primary__btn addToCartBtn" data-id="{{ $product_details->id }}" data-price="{{ $product_details->price }}" href="{{route('checkout')}}">Buy it now</button>
                                    </div>
                                ...
                                <div id="description" class="tab_pane active show">
                                    <div class="product__tab--content">
                                        <div class="product__tab--content__step mb-30">
                                            ...
                                            <p class="product__tab--content__desc"> {{ $product_details->description }}</p>
                                        </div>
